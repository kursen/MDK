...
Partial Class SyncService
    ...
    Shared Sub Main(cmdArgs() As string)
        ...
        '
        ServicesToRun = New System.ServiceProcess.ServiceBase() {New SyncService(cmdArgs)}
    ...
    Private Sub InitializeComponent()
        ...
        'SyncService
        '
        Me.ServiceName = "SyncService"
        CType(Me.log, System.ComponentModel.ISupportInitialize).EndInit()

    End Sub
    Friend WithEvents log As System.Diagnostics.EventLog
