...
(function ($, window, document) {
	...
	Timepicker.prototype = {
			...
			if (this.showMeridian) {
				...
				if (this.maxHours == 24) {
					if (this.hour > this.minHours) {
						this.hour--;
					} else if (this.hour == this.minHours) {
						this.hour = 0;
						this.minute = 0;
					} else if (this.hour == 0) {
						this.hour = 23;
		...
		decrementMinute : function (step) {
			...
			if ((this.hour == 0) && (this.maxHours == 24)) {
				this.minute = 0;
			} else if (this.hour == this.maxHours) {
				this.minute = 0;
			}
		},
		...
		incrementHour : function () {
			...
			if (this.maxHours == 24) {
				...
				else if (this.hour > this.maxHours && this.minute>0) {
					this.hour = this.minHours;
				} else if (this.hour < this.minHours) {
					this.hour = this.minHours;
				} else {
		...
		showWidget : function () {
			...
			if (this.hour === '') {
				if (this.defaultTime) {
					...
					//this.setTime('0:0:0');
					this.setTime(this.minHours + ':0:0');
				}
			} else if (this.hour == 0) {
				if (this.maxHours == 24) {
					this.setTime('0:0:0');
		...
		update : function (ignoreWidget) {
			...
			// if ((this.hour == this.maxHours) && (this.maxHours == 24)) {
			// this.hour = 0;
			// this.minute = 0;
			// this.second = 0;
			// }

			// if ((this.hour < this.minHours) && (this.maxHours != 24)) {
			// this.hour = this.minHours;
			// }
