@Using Html.BeginForm("CropPhoto", "Employee", Nothing, FormMethod.Post, New With {.id = "frmEditPhoto"})
    @<input type="hidden" name="userid" id="userid" value="@ViewData("id")" />
...
<script src="@Url.Content("~/Areas/HRD/js/uploadphoto.js")" type="text/javascript"></script>
