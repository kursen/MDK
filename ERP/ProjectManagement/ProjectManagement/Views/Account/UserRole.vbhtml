...
End Code
<h2>
    @Html.Raw(ViewData("userid").ToString())
</h2>
...
@Using Html.BeginJUIBox("Daftar Role")
    ...
    @<div class="row form-horizontal">
        ...
        @Html.WriteFormInput(Html.DropDownList("WorkUnit", Nothing, Nothing, New With {.class = "form-control"}), "Unit Kerja")
        @Html.WriteFormInput(Html.DropDownList("ModuleNames", Nothing, Nothing, New With {.class = "form-control"}), "Nama Modul")
    </div>
