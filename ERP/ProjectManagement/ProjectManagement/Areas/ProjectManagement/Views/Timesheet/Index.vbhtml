...
<script type="text/javascript">
    ...
    var _loadContent = function () {
        ...
        $.ajax({
            url: '/Timesheet/GetTimeSheetContent',
            data: { id: _ProjectId },
            type: 'POST',
    ...
    var _loadFooter = function () {
        var _ProjectId = $("#ProjectInfoId").val();
        $.ajax({
            url: '/Timesheet/GetTimesheetFooter',
            data: { id: _ProjectId },
            type: 'POST',
    ...
    $(function () { //init js
        ...
        $("#btnPrint").click(function () {
            ...
            window.location = "/Timesheet/PrintTimeSheet/?ProjectId=" + projectId;
        });
        ...
        datatableDefaultOptions.fnDrawCallback = function (settings) {
            ...
            api.column(0, { page: 'current' }).data().each(function (group, i) {
                ...
                if (currentdivisionId != divisionId) {
                    ...
                    for (var nweek = 0; nweek < _numberOfWeeks + 3; nweek++) {
                        _html += "<td>&nbsp;</td>";
        ...
        $('body').editable({
            ...
            params: function (p) {
                ...
                p.taskweight = $.number(datarow.taskweight, 2, ",", ".");
            ...
            title: function (e) {
                ...
                "<dt>Bobot</dt><dd>" + datarow.taskweight + "</dd>" +
			    "</dt>";
                return _dtlist;
            },
