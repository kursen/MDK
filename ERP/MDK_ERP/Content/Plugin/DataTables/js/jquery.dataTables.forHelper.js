...
detailRow_Distribution = function (d, isDelivery) {
    ...
    return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;margin: -8px -10px -6px 10px;" class="table table-hovered table-striped">' +
            ...
            '</tr>' +
            '<tr>' +
                '<th style="width:120px">Nota ' + (isDelivery ? "Pengiriman" : "Penerimaan") + '</th>' +
                '<td style="width:10px"> : </td>' +
                '<td>' + isNull(d.Place) + '</td>' +
            '</tr>' +
            '<tr>' +
                '<th style="width:120px">' + 'Clerk 1' + '</th>' +
                '<td style="width:10px"> : </td>' +
                '<td>' + isNull(d.Clerk1) + '</td>' +
            '</tr>' +
            '<tr>' +
                '<th style="width:120px">' + 'Clerk 2' + '</th>' +
                '<td style="width:10px"> : </td>' +
                '<td>' + isNull(d.Clerk2) + '</td>' +
            '</tr>' +
            '</table>';
}
