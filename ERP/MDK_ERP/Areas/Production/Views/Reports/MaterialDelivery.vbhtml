...
<h4 class='inline'>
    Laporan Pengiriman Material</h4>
<a id="btn-print" class="btn btn-sm btn-success pull-right" href="@Url.Action("../../Reports/LaporanPengirimanMaterial.xlsx")">
    <i class="icon-print"></i> Cetak Laporan</a>
<div class="clear"></div>
@Using Html.WriteSummaryBox("Pengiriman Material", "icon-file-text-alt")
...
@Section jsScript
    ...
    <script type="text/javascript" src="@Url.Content("~/Areas/Production/Scripts/Reports/MaterialDelivery.js")"></script>
End Section
