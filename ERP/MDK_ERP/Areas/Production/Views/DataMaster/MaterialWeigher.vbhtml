...
@Code
    ...
    ViewData("BreadCrumb") = Html.BreadCrumb({ _
                                             ...
                                             {"Daftar Inventaris Timbangan", Nothing}
                                         }).ToString()
End Code
@imports MDK_ERP.HtmlHelpers

<h4 class='inline'><i class='icon-book'></i> Daftar Invetaris Timbangan</h4>
...
<!-- start modal >> tipe Stok -->
    <!-- -->
    @Using Html.ModalForm("modal-Data", "Invetaris Timbangan", Url.Action("", ""), "", "POST", "form-Data", "form-horizontal")
...
@Section jsScript
    ...
    <script type="text/javascript" src="@Url.Content("~/Areas/Production/Scripts/DataMaster/Weigher.js")"></script>
End Section
