...
End Code
@Using Html.BeginJUIBox("Perawatan Alat Berat")
    @<div class="row">
        <div class="col-lg-12 col-sm-12">
            <div class="btn-group pull-right">
            @Html.ActionLink("Tambah Data", "CreateMaintenanceRecord", "HeavyEquipmentMaintenance", Nothing, New With {.class = "btn btn-primary"})
    ...
    @<div class="row">
        <div class="col-lg-12 col-sm-12">
        @Using Html.BeginForm("GetMaintenanceList", "HeavyEquipmentMaintenance", Nothing, FormMethod.Post, New With {.class = "form-horizontal",
...
<script type='text/javascript'>
    ...
    var _initTblData = function () {
        ...
        var _lnk_View = function (e) {
            ...
            window.location = "/Equipment/HeavyEquipmentMaintenance/Detail/" + data.Id;

        }
        var _lnk_Edit = function (e) {
            e.preventDefault();
            var data = _getDataTableRow(this).data();
            window.location = "/Equipment/HeavyEquipmentMaintenance/Edit/" + data.Id;
        }
        var _lnk_Delete = function (e) {
            e.preventDefault();
            var data = _getDataTableRow(this).data();
            var _url = "/Equipment/HeavyEquipmentMaintenance/Delete";
