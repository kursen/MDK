        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    ...
                    <input type='hidden' id='hHeavyEqpCode' value='0' />
                    <br />
                    <br />
...
<script type="text/javascript">
    ...
    var _loadData = function () {
        ...
        var _url = "/Equipment/HeavyEquipmentMaintenance/GetProposedHeavyEqpToMaintainList";
        $.ajax({
            type: 'POST',
            url: _url,
            dataType: 'json',
    ...
    var _initTblServiceSchedule = function () {
        ...
        var arrColumns = [
              { "data": "HeavyEqpId", "sClass": "text-right" },
              { "data": "Code" },
              { "data": "Merk" },
              { "data": "Species" },
              { "data": "HeavyEqpId", "sClass": "text-center", "mRender": _renderDetail }
        ];
    ...
    var _lnkViewItem_click = function (e) {
        ...
        $("#hHeavyEqpCode").val(row.data().HeavyEqpId);
        tblItems.clear();
        tblItems.rows.add(row.data().HeavyEqp).draw();
    ...
    var _lnkDoMaintenance_click = function (e) {
        ...
        e.preventDefault();
        var row = _getDataTableRow(this);
        OpenMaintenanceForm(row.data().HeavyEqpId);
    }
    ...
    var OpenMaintenanceForm = function (heavyeqpCode) {

        window.location = "/Equipment/HeavyEquipmentMaintenance/CreateMaintenanceRecord/" + heavyeqpCode;
    };
    ...
    $(function () {
        ...
        $("#btnDoMaintenance").click(function () {
            var HeavyEqpCode = $("#hHeavyEqpCode").val();
            OpenMaintenanceForm(heavyeqpCode);
        });
