@Code
    ViewData("Title") = "Setting Operator dan Supir"
    Dim css_table = "table table-bordered table-datatable dataTable"
End Code
@Using Html.BeginJUIBox("Setting Operator dan Supir")
    @<div class="row">
        <div class="col-lg-12 col-sm-12">
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#tab_heavyequipment" aria-controls="home"
                    role="tab" data-toggle="tab">ALAT BERAT</a></li>
                <li role="presentation"><a href="#tab_vehicle" aria-controls="profile" role="tab"
                    data-toggle="tab">KENDARAAN</a></li>
            </ul>
...
End Using
<link type="text/css" href="../../../../plugins/bootstrap-editable/bootstrap-editable.css"
    rel="stylesheet" />
...
<script type="text/javascript">
    ...
    var _localLoad = function () {
        ...
        $.ajax({
            url: '/Equipment/VehicleArea/GetHeavyEquipmentList',
            type: 'POST',
    ...
    var initTblHeavyEquipment = function () {
        var _renderHeavyEquipmentEditableColumn = function (data, type, row) {
            ...
            if (type == "display") {
                ...
                '" data-url="/Equipment/VehicleArea/SaveHeavyEquipmentToNewLocation" data-title="Pilih Unit Kerja">' + data + '</a>';
            }
            return data;
        }
        ...
        var _renderVehicleEditableColumn = function (data, type, row) {
            ...
            if (type == "display") {
                ...
                return '<a href="#" name="officename" class="officename" data-type="select" data-pk="' + row.ID +
                '" data-url="/Equipment/VehicleArea/SaveVehicleToNewLocation" data-title="Pilih Unit Kerja">' + data + '</a>';
            }
            return data;
        }
        var _renderOperatorEditableColumn = function (data, type, row) {
            ...
            if (type == "display") {
                ...
                '" data-url="/Equipment/VehicleArea/SaveDefaultOperator" data-title="Pilih Operator">' + data + '</a>';
            }
            return data;
        }
        ...
        var _renderDriverEditableColumn = function (data, type, row) {
            ...
            if (type == "display") {
                ...
                '" data-url="/Equipment/VehicleArea/SaveDefaultDriver" data-title="Pilih Supir">' + data + '</a>';
            }
            return data;
        }
        ...
        arrColumns.push({ "data": "OprName", "mRender": _renderOperatorEditableColumn });
        ...
        arrColumns2.push({ "data": "OprName", "mRender": _renderDriverEditableColumn });
    ...
    var initEditable = function (arrsource) {
        ...
        $('.IDOpr').editable({
            select2: {
                ...
                ajax: {
                    type: 'POST',
                    url: '/Equipment/VehicleArea/GetOperators',
                    dataType: 'json',
        ...
        $('.IDDriver').editable({
            select2: {
                ...
                ajax: {
                    type: 'POST',
                    url: '/Equipment/VehicleArea/GetDrivers',
                    dataType: 'json',
                    data: function (term, page) {
                        var officeId = 0;
