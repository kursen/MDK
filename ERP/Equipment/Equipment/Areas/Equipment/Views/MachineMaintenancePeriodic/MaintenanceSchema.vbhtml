@modelType  Equipment.MachineEqpMaintenanceCheck
@Code
...
@Using Html.BeginJUIBox("Skema Perawatan Kendaraan")
    ...
    Using Html.BeginForm("SaveMachineEqpMaintenance", "MachineMaintenancePeriodic", Nothing, FormMethod.Post, New With {.class = "form-horizontal", .id = "frmMachineEqpmaintenance", .autocomplete = "off"})
    ...
    @<div class="row">
        <div class="col-sm-12 col-lg-12 form-horizontal">
            ...
            @Html.Hidden("MachineEqpId", Model.MachineEqp.ID)
            @Html.WriteFormInput(WriteSpanControl(Model.MachineEqp.Name, "spName"), "Nama Mesin")
            @*@Html.WriteFormInput(WriteSpanControl(Model.HeavyEqp.Type, "spPoliceNumber"), "No. Polisi")*@
            @Html.WriteFormInput(WriteSpanControl(Model.MachineEqp.Merk & "/" & Model.MachineEqp.Type, "spMerkType"), "Merk/Type")
    ...
    @<div class="row">
        <div class="col-sm-12 col-lg-12">
            ...
            <div id="form-item" style="display: none;">
                ...
                @Using Html.BeginForm("ValidateMachineEqpCheckItem", "MachineMaintenancePeriodic", Nothing, FormMethod.Post, New With {.class = "form-horizontal", .id = "frmitem", .autocomplete = "off"})
                        Using Html.BeginJUIBox("Kegiatan Perawatan", False, False, False, False, False, "fa fa-wrench")
                    @Html.HiddenFor(Function(m) m.ID, New With {.id = "IDMachineEqpMaintenanceItem"})
                    @Html.Hidden("MachineEqpMaintenanceCheckId", 0)
            ...
            <div class="well">
                <div style="width: 200px" class='center-block'>
                    <button type="button" class="btn btn-primary" id="btn-save">
                        Simpan</button>
                    <a href='@Url.Action("Index", "MachineMaintenancePeriodic")' class="btn btn-primary">
                        Kembali</a>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    submitFormCallback = function (data) {
        if (data.stat == 0) {
            ...
            window.location = "/Equipment/MachineMaintenancePeriodic/Index/";
        }
    }
    ...
    initTblSchema = function () {
        ...
        var _localLoad = function (data, callback, setting) {
            ...
            $.ajax({
                url: '/MachineMaintenancePeriodic/GetListMaintenanceSchemaItem',
        ...
        var arrColumns = [
              ...
              {"data": "MachineEqpMaintenanceCheckId", "sClass": "text-center", "mRender": _renderEditColumn }
        ];
        ...
        .on("click", ".delete", function (d) {
            ...
            $.ajax({
                type: 'POST',
                url: '/MachineMaintenancePeriodic/DeleteMaintenanceItem',
                data: { id: row.data().ID },
                dataType: 'json',
        ...
        .on("click", ".edit", function () {
            ...
            $("#IDMachineEqpMaintenanceItem").val(dataItem.ID);
            $("#rowIdx_item").val(row.index());

            $("#MachineEqpMaintenanceCheckId").val(dataItem.MachineEqpMaintenanceCheckId);
            $('#ItemName').val(dataItem.ItemName);
            $('#UnitValue').val(dataItem.UnitValue);
            $('#Value').val(dataItem.Value);
            $('#LastCheck_HM').val(dataItem.LastCheck_HM);
    ...
    $(function () {
        ...
        $('#btnadditem').click(function () {
            ...
            $('#IDMachineEqpMaintenanceItem').val(0)
            $('#MachineEqpMaintenanceCheckId').val(0)
            $('#rowIdx_item').val(-1);
        ...
        $('#btn-saveItem').click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.stat == 1) {
                        var NumberId = $('#IDMachineEqpMaintenanceItem').val();
                        ...
                        if (data.idx == -1) {
                            ...
                            arrData.splice(data.rowIdx, 1, ItemSchema);
                            tblSchema.clear();
        ...
        $('#btn-save').click(function (e) {
            ...
            var _data = $('#frmMachineEqpmaintenance').serializeArray();
            var _urlaction = $('#frmMachineEqpmaintenance').attr('action');
            $.ajax({
                type: 'POST',
                data: _data,
                url: _urlaction,
