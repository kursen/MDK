...
@Using Html.BeginJUIBox("Perawatan Mesin")
    @<div class="row">
        <div class="col-lg-12 col-sm-12">
            ...
            @Html.ActionLink("Tambah Data", "CreateMaintenanceRecord", "MachineMaintenance", Nothing, New With {.class = "btn btn-primary"})
            </div>
        </div>
    </div>
    ...
    @<div class="row">
        <div class="col-lg-12 col-sm-12">
        @Using Html.BeginForm("GetMaintenanceList", "MachineMaintenance", Nothing, FormMethod.Post, New With {.class = "form-horizontal",
...
<script type='text/javascript'>
    ...
    var _initTblData = function () {
        ...
        var _lnk_View = function (e) {
            ...
            window.location = "/Equipment/MachineMaintenance/Detail/" + data.Id;

        }
        var _lnk_Edit = function (e) {
            e.preventDefault();
            var data = _getDataTableRow(this).data();
            window.location = "/Equipment/MachineMaintenance/Edit/" + data.Id;
        }
        var _lnk_Delete = function (e) {
            e.preventDefault();
            var data = _getDataTableRow(this).data();
            var _url = "/Equipment/MachineMaintenance/Delete";
        ...
        var arrColumns = [
            ...
            {"data": "MaintenanceDateStart", "sClass": "text-center", "mRender": _fnRenderNetDate }, //
              {"data": "Name" }, //
              {"data": "SerialNumber", "sClass": "text-center" }, //
              {"data": "Remark" }, //
              {"data": "Merk" }, //
