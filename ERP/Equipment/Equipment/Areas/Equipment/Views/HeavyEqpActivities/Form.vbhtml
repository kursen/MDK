@ModelType Equipment.HeavyEqpActivity
@Code
    ViewData("Title") = "Kegiatan Alat Berat"
...
@helper WriteOperationTableColumnGroup()
    Dim colWidth = {"60px", "auto", "100px", "200px", "80px", "80px", "100px", "120px"}
...
@Using Html.BeginForm("SaveItemActivities", "HeavyEqpActivities", Nothing, FormMethod.Post, New With {.id = "frmactivity", .autocomplete = "off"})
    Using Html.BeginJUIBox("Kegiatan Alat Berat", False, False, False, False, False, "fa fa-ship")
    @*@Html.HiddenFor(Function(m) m.ID, New With {.id = "heavyEqpActivityID"})*@
    @<input type="hidden" name="ID" value="@Model.ID" id="heavyEqpActivityID" />
    @<div class="row">
    </div>
    @<div class="row">
            ...
            <div class="col-md-3 col-sm-12">
                @Html.WriteFormDateInputFor(Function(m) m.Date, "Tanggal",
                                    New With {.format = "dd-mm-yyyy", .autoclose = "true",
                                              .orientation = "top left", .todayBtn = "linked", .language = "id"},
            ...
            <div class="col-md-5 col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8 col-sm-4">
                        ...
                        <span class="form-control" id="spMerk">@Model.Merk</span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-4 col-sm-4 control-label">
                    ...
                    <div class="col-lg-8 col-sm-4">
                        ...
                        <span class="form-control" id="spType">@Model.Type</span>
                    </div>
                </div>
...
@Using Html.BeginJUIBox("Operation", True, False, False, False, False, "")
    ...
    @<div id="formOperasi" style="display: none;">
        @Using Html.BeginForm("ValidateOperation", "HeavyEqpActivities", Nothing, FormMethod.Post,
                             New With {.class = "form-horizontal", .autocomplete = "Off", .id = "frmOperation"})
            ...
            @<div class="form-group">
                ...
                <div class="col-lg-3 col-sm-4">
                    @Html.TextBox("OperationType", Nothing, New With {.class = "form-control"})
                </div>
            </div>
            @<div class="form-group">
                <label class="col-lg-3 col-sm-4 control-label">
                ...
                <div class="col-lg-1 col-sm-4">
                    @Html.DecimalInput("VolumeOperation", 0, ".", ",", 1)
                </div>
            </div>
            @<div class="form-group">
                <label class="col-lg-3 col-sm-4 control-label">
                ...
                <div class="col-lg-3 col-sm-4">
                    @Html.TextBox("LocationOperation", Nothing, New With {.class = "form-control"})
                </div>
            </div>
            @<div class="form-group">
                <label class="col-lg-3 col-sm-4 control-label">
            ...
            @<div class="form-group">
                ...
                <div class="col-lg-3 col-sm-4">
                    @Html.TextBox("PacketOperation", Nothing, New With {.class = "form-control"})
                </div>
            </div>
            ...
            @<div class="form-group">
                <div class="col-sm-offset-3 col-sm-10">
                    <button type="button" class="btn btn-primary" id="btnSaveOp">
                        Tambah</button>
                    <button type="button" class="btn btn-default" onclick="$('#btnAddOpr').click()">
                        Tutup</button>
                </div>
            </div>
    End Using
    ...
    @<div class="row">
        <div class="col-lg-12 col-sm-12">
            ...
            <div id="formNonOpr" style="display: none;">
                @Using Html.BeginForm("ValidateNonOperation", "HeavyEqpActivities", Nothing, FormMethod.Post, New With {.class = "form-horizontal", .autocomplete = "Off", .id = "frmNonOperation"})
            ...
            @<div class="row">
                <div class="col-lg-12 col-sm-12">
                    ...
                    <div id="formOil" style="display: none;">
                        @Using Html.BeginForm("ValidateOil", "HeavyEqpActivities", Nothing, FormMethod.Post, New With {.class = "form-horizontal", .autocomplete = "Off", .id = "frmoil"})
            ...
            @<div class="row">
                <div class="col-lg-12 col-sm-12">
                    ...
                    <div id="formBBm" style="display: none;">
                        @Using Html.BeginForm("ValidateFuel", "HeavyEqpActivities", Nothing, FormMethod.Post,
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-sm-4">
                                @Html.TextBoxFor(Function(m) m.JabatanKnowBy, New With {.class = "form-control"})
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-sm-4">
                               <span class="form-control">OPERATOR</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="well">
    <div class="col-lg-offset-5 col-sm-offset-3">
        <button type="button" class="btn btn-primary" id="btnSaveActivity">
            Simpan</button>
        <a href="@Url.Action("Index", "HeavyEqpActivities")" class="btn btn-default" >Batal</a>
    </div>
</div>
<!--end form-->
<!-- end form-->
...
<style>
    .tblworkhour .ui-state-focus, #formNonOpr .ui-state-focus
    {
        background-color: Blue;
        background-image: none;
    }
    .tblworkhour .ui-widget-header, #formNonOpr .ui-widget-header
    {
...
<script type="text/javascript">
    ...
    var submitFormActivityCallback = function (data) {
        if (data.stat == 0) {
            ...
            $.notify({
                ...
                url: '/Equipment/HeavyEqpActivities/Detail/' + data.id
            }, {
                type: 'warning',
                newest_on_top: true,
                delay: 0,
            ...
            window.location = '/Equipment/HeavyEqpActivities/';
        }
    ...
    var _initTblOperation = function () {
      ...
      '</div>';
        ...
        var arrColumnsOp = [
            ...
            {'data': 'OperationType' }, //
            {'data': 'VolumeOperation', 'sClass': 'text-right', 'mRender': _fnRender2DigitDecimal }, //
            {'data': 'LocationOperation' }, //
            {'data': 'BeginHM', 'sClass': 'text-right', 'mRender': _fnRender2DigitDecimal }, //
            {'data': 'EndHM', 'sClass': 'text-right', 'mRender': _fnRender2DigitDecimal }, //
            {'data': 'PacketOperation' },
            { 'data': '', 'mRender': _renderEditColumnOp, 'sClass': 'text-center' }
        ];
        ...
        .on('click', '.btRemoveItemOperation', function (d) {
            ...
            $.ajax({
                ...
                url: '/HeavyEqpActivities/DeleteOperation',
            ...
            $('#OperationType').val(dataItem.OperationType);
            $('#VolumeOperation').val(dataItem.VolumeOperation);
            $('#LocationOperation').val(dataItem.LocationOperation);
            $('#BeginHM').val(dataItem.BeginHM);
            $('#EndHM').val(dataItem.EndHM);
            $('#PacketOperation').val(dataItem.PacketOperation);
    ...
    var _initTblNonOperation = function () {
        ...
        .on('click', '.btnRemoveItemNonOperation', function (d) {
            ...
            $.ajax({
                ...
                url: '/HeavyEqpActivities/DeleteNonOperation',
                success: function (data) {
                    if (data.stat == 1) {
                        row.remove().draw();
                    }
    ...
    var _initTblOilUsages = function () {
        ...
        tblOil = $('#tblpelumas').DataTable(datatableDefaultOptions).on('click', '.btnRemoveItemOil', function (d) {
            ...
            $.ajax({
                ...
                url: '/HeavyEqpActivities/DeleteOil',
                success: function (data) {
                    if (data.stat == 1) {
                        row.remove().draw();
                    }
    ...
    var _initTblBBM = function () {
        ...
        .on('click', '.btnRemoveItemFuel', function (d) {
            ...
            $.ajax({
                ...
                url: '/HeavyEqpActivities/DeleteFuel',
                success: function (data) {
                    if (data.stat == 1) {
                        row.remove().draw();
                    }
    ...
    var _loadDocument = function () {
        if (parseInt($('#heavyEqpActivityID').val()) != 0) {
            $.ajax({
                method: 'post',
                url: '/HeavyEqpActivities/loadActivity',
                data: {
                    id: $('#heavyEqpActivityID').val()
                },
                dataType: 'json',
                success: function (data) {
    ...
    var _initAutoComplete = function () {
        $('#OilType').autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: '/HeavyEqpActivities/getOilType',
                    data: {
                        term: $('#OilType').val()
                    },
                    dataType: 'json',
        ...
        $('#LocationOperation').autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: '/Equipment/HeavyEqpActivities/AutocompleteLocation',
                    data: {
                        term: $('#LocationOperation').val()
                    },
                    dataType: 'json',
                    success: function (data) {
                        response($.map(data, function (obj) {
        ...
        $('#NonOperationType').autocomplete({
            source: function (request, response) {
                $.ajax({
                    url: '/HeavyEqpActivities/AutocompleteNonOperationType',
                    data: {
    ...
    $(document).ready(function () {
                ...
                success: function (data) {
                    if (data.stat == 1) {
                        ...
                        var OperationItem = {
                            ...
                            VolumeOperation: $('#VolumeOperation').val(),
                            LocationOperation: $('#LocationOperation').val(),
                            BeginHM: $('#BeginHM').val(),
                            EndHM: $('#EndHM').val(),
                            PacketOperation: $('#PacketOperation').val()
                        };
                        if (data.idx == -1) {
        ...
        $('#btnSaveActivity').click(function (e) {
            ...
            _data.push({ "name": "CorrectBy", "value": $("#CorrectBy").val() });
            _data.push({ "name": "JabatanCorrectBy", "value": $("#JabatanCorrectBy").val() });
            _data.push({ "name": "KnownBy", "value": $("#KnownBy").val() });
            _data.push({ "name": "JabatanKnowBy", "value": $("#JabatanKnowBy").val() });
            $.ajax({
                type: 'POST',
                data: $.param(_data),
                url: '/Equipment/HeavyEqpActivities/SaveItemActivities',
                dataType: 'json',
