...
@Code
    ViewData("Title") = "Detail Kegiatan Alat Berat"
    ...
    <div class="col-lg-12 col-sm-12">
        <div class="pull-right">
            <div class="button-group">
                <a   href="@Url.Action("Edit", "HeavyEqpActivities", New With {.id = Model.ID})"class="btn btn-danger btn-label-left" >
                    <span><i class="fa fa-edit"></i></span>Edit</a>
                <a href="@Url.Action("Index", "HeavyEqpActivities")" class="btn btn-danger btn-label-left">
                <span><i class="fa fa-arrow-left"></i></span>
                    Kembali</a>
                    <a href="@Url.Action("Index", "Report", New With {.id = Model.ID})" class="btn btn-danger btn-label-left">
...
@Using Html.BeginJUIBox("Detail Kegiatan Alat Berat")
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body" style="min-height: 100px;">
                    <table  class="@tableClass" >
                        <colgroup>
                            @code
    Dim colWidth = {"60px", "auto", "120px", "250px", "80px", "80px"}
    ...
    Dim counter As Integer = 1
                            End Code
                            @For Each item In Model.HeavyEqpOperations
                                @<tr>
                                    <td>@counter
                                    </td>
                                    <td>@item.OperationType
                                    </td>
                                    <td>@item.VolumeOperation
                                    </td>
                                    <td>@item.LocationOperation
                                    </td>
                                    <td>@item.BeginHM
                                    </td>
                                    <td>@item.EndHM
    ...
    Next
                            @code 
    If Model.HeavyEqpOperations.Count = 0 Then
                                @<tr>
                                    <td colspan="6">
                                        [Tidak ada data]
                                    </td>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body" style="min-height: 100px;">
                    <table class="@tableClass">
                        ...
                        <tbody>
                            @For Each item In Model.FuelUsedHeavyEqps
                                @<tr>
                                    <td>
                                        @item.AmountFuel
                                    </td>
    ...
    Next
                            @If Model.FuelUsedHeavyEqps.Count = 0 Then
                                @<tr>
                                    <td>
                                        -
                                    </td>
    ...
    counter = 1
                            End Code
                            @For Each item In Model.HeavyEqpNonOperations
                                @<tr>
                                    <td>@counter.
                                    </td>
        ...
        counter += 1
    Next
                            @If Model.HeavyEqpNonOperations.Count = 0 Then
                                @<tr>
                                    <td colspan="5">
                                        [Tidak ada data]
                                    </td>
                ...
                <div class="panel-body">
                    <table class="@tableClass">
                        ...
                        <tbody>
                            @code
    counter = 1
    For Each item In Model.OilUsedHeavyEqps
                                @<tr>
                                    <td>@counter.
                                    </td>
                                    <td>@item.OilType
        ...
        counter += 1
    Next
    If Model.OilUsedHeavyEqps.Count = 0 Then
                                @<tr>
                                    <td colspan="3">
                                        [Tidak ada data]
                                    </td>
