    ...
    <div class="col-lg-12 col-sm-12">
        <div class="pull-right">
            ...
            @If Model.DocState <= 1 Then
                @<a href="@Url.Action("Edit", "ProjectPurchasingRequest", New With {.id = Model.Id})" class="btn btn-danger btn-label-left">
            ...
            End If
                    ...
                    <span><i class="fa fa-list"></i></span>Daftar Permintaan</a>
                     <a href="@Url.Action("PrintPR", "ProjectPurchasingRequest", New With {.id = Model.ID})" class="btn btn-danger btn-label-left">
